package com.familycode.myfamilyspringboot.views.imagelist;
...
public class ImageListViewCard extends ListItem {
    ...
    public ImageListViewCard(String text, String url) {
        ...
        Paragraph description = new Paragraph("Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut.");
